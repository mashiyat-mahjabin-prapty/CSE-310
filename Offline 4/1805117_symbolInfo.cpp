...
class SymbolInfo:public Function{
    public:
        ...
        SymbolInfo(SymbolInfo &s) : Function()
        {
            ...
            this->stack_offset = s.stack_offset;
            this->arr_sz = s.arr_sz;
        }
        SymbolInfo(string name, string type="", string typeSpecification="", int size=0, int arr_sz=0, int offset=0) : Function() 
        {
            //cout << "A new symbolInfo object created" << endl;
            this->name = name;
            this->type = type;
